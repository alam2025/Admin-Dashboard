    ...
    <div className="mt-3 font-Inter">
      ...
      <div className="flex flex-col gap-2  p-2">
        <div className="flex justify-between ">
          ...
          <div>
            <AiFillHeart className="text-[#04A999] text-xl cursor-pointer" />
          </div>
        </div>
...
export default UserLiveCreateFavourite